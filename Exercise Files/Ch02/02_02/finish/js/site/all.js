(function () {
            ...
            if (
              ...
              if (pager) {
                for (var i = 1; i <= slidesCount; i++) {
                  li +=
                    '<li><a href="#slide-' + i + '">Slide ' + i + "</a></li>";
                }
  ...
  /**
   *  Constructor function set custom properties for each object type (Arrangement type in this case)   *
   *
   * @param {*} name
   * @param {*} vase
   * @param {*} quantity
  ...
  // Common properties set via constructor prototypes
